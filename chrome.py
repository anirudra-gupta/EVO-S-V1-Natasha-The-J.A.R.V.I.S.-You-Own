...
def search_google(query):
    ...
    print(
        Fore.LIGHTYELLOW_EX + 'Opening Google and search about ' +
...
def search_youtube(query):
    ...
    print(
        Fore.LIGHTYELLOW_EX + 'Opening YouTube and search about ' +
        Fore.LIGHTBLUE_EX + query + Style.RESET_ALL
    )
...
def search_facebook(query):
    ...
    print(
        Fore.LIGHTYELLOW_EX + 'Opening FaceBook and search about ' +
        Fore.LIGHTBLUE_EX + query + Style.RESET_ALL
    )
